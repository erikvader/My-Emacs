...
#+begin_src emacs-lisp :tangle yes
  ;; (setq hl-paren-attributes '((:underline t :weight extra-bold)))
  ;; (setq hl-paren-colors '("#ccccc7"))
  ...
  ;; advice from internet to hihglight parentheses inside them
  ;; show-paren-function
  (define-advice sp-show--pair-function (:around (fn) fix)
    ...
    (when show-smartparens-mode
      (cond ((looking-at-p "\\s(") (funcall fn))
            (t (save-excursion
                 ...
                 (while (and (characterp (char-after))
...
#+begin_src emacs-lisp :tangle yes
  ...
  (define-key eyebrowse-mode-map (kbd "C-<delete>") 'eyebrowse-close-window-config)

...
#+begin_src emacs-lisp :tangle yes
  ...
  (define-key evil-normal-state-map (kbd "H-h") 'sp-move-sexp-back)
  (define-key evil-normal-state-map (kbd "H-j") 'sp-add-to-next-sexp)
  (define-key evil-normal-state-map (kbd "H-k") 'sp-extract-before-sexp)
  (define-key evil-normal-state-map (kbd "H-l") 'sp-move-sexp-forward)

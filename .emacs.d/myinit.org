...
#+begin_src emacs-lisp :tangle yes
  ...
  (define-key evil-normal-state-map (kbd "Y") 'browse-kill-ring)
  ...
  (evilem-define (kbd "SPC [n") 'sp-next-sexp)
  (evilem-define (kbd "SPC ]n") 'sp-forward-sexp)
  (evilem-define (kbd "SPC [p") 'sp-backward-sexp)
  (evilem-define (kbd "SPC ]p") 'sp-previous-sexp)
  (evilem-define (kbd "SPC [s") 'sp-beginning-of-sexp)
  (evilem-define (kbd "SPC ]s") 'sp-end-of-sexp)
  ...
  (define-key evil-motion-state-map (kbd "[n") 'sp-next-sexp)
  (define-key evil-motion-state-map (kbd "]n") 'sp-forward-sexp)
  (define-key evil-motion-state-map (kbd "[p") 'sp-backward-sexp)
  (define-key evil-motion-state-map (kbd "]p") 'sp-previous-sexp)
  (define-key evil-motion-state-map (kbd "[s") 'sp-beginning-of-sexp)
  (define-key evil-motion-state-map (kbd "]s") 'sp-end-of-sexp)
  (define-key evil-motion-state-map (kbd "[d") 'sp-down-sexp)
  (define-key evil-motion-state-map (kbd "]d") 'sp-down-sexp)

  (define-key evil-motion-state-map (kbd "[w") 'eriks-skip-space-backwards)
  (define-key evil-motion-state-map (kbd "]w") 'eriks-skip-space)
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; other ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  (evil-mode 1)

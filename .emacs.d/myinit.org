...
#+begin_src emacs-lisp :tangle yes
  ...
  (define-key evil-normal-state-map (kbd "gsg") 'evil-operator-google-search)
  (define-key evil-normal-state-map (kbd "gsj") 'eriks-evil-javadoc-search-operator)
  ...
  (define-key evil-normal-state-map (kbd "SPC C-s") 'eriks-evil-swiper-operator)
  (define-key evil-visual-state-map (kbd "SPC C-s") 'eriks-evil-swiper-operator)

  (define-key evil-normal-state-map (kbd "SPC c") 'evil-operator-clone)
  (define-key evil-visual-state-map (kbd "SPC c") 'evil-operator-clone)
  ...
  (setq evil-operator-moccur-grep-find-key "gsm")

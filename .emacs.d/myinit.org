...
#+begin_src emacs-lisp :tangle yes
  ...
  (define-key evil-normal-state-map (kbd "H-a") 'sp-extract-after-sexp)
...
#+begin_src emacs-lisp :tangle yes
  (defvar highlight-parens-on t "whether to blah")

  (defun toggle-highlight-parens ()
    (interactive)
    (setq highlight-parens-on (not highlight-parens-on)))

  (define-key eriks-map (kbd "C-h") 'toggle-highlight-parens)

...
#+begin_src emacs-lisp :tangle yes
  ...
  (define-key evil-spc (kbd "C--") 'evil-numbers/dec-at-pt)
  (define-key evil-spc (kbd "C-+") 'evil-numbers/inc-at-pt)

  (define-key evil-spc (kbd ";") 'comment-dwim)

  (define-key evil-spc (kbd "J") 'evil-join)

  (require 'evil-easymotion)
  (evilem-default-keybindings "SPC") ;;TODO: vara på space elr int? vara på comma?
  ...
  (define-key evil-motion-state-map (kbd "K") 'sp-backward-up-sexp)
  (define-key evil-normal-state-map (kbd "J") nil)
  (define-key evil-visual-state-map (kbd "J") nil)
  (define-key evil-motion-state-map (kbd "J") 'sp-down-sexp)
  (define-key evil-motion-state-map (kbd "H") 'sp-backward-sexp)
  (define-key evil-motion-state-map (kbd "L") 'sp-forward-sexp)

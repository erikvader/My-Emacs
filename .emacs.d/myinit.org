...
#+begin_src emacs-lisp :tangle yes
  ...
  (define-key evil-normal-state-map (kbd "gSs") 'eriks-evil-swiper-operator)
  (define-key evil-visual-state-map (kbd "gSs") 'eriks-evil-swiper-operator)
  ...
  (defun erik-evil-surround-text ()
    (let ((text (read-from-minibuffer "" "")))
      (cons text text)))

  (setq-default evil-surround-pairs-alist (cons '(?s . erik-evil-surround-text) evil-surround-pairs-alist))
